...
<center>
<?php
$ontime = shell_exec('mysql -h 192.168.1.143 -u root -proot -s -N -e "SELECT \`On\` FROM Lighting.Time"');
$offtime = shell_exec('mysql -h 192.168.1.143 -u root -proot -s -N -e "SELECT \`Off\` FROM Lighting.Time"');
...
<div>
	...
	<br>
<select name="timeoff" id="timeoff">
